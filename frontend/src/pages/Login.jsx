...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-8rem)] relative z-10 px-4">
      {/* Decorative Orbs */}
      <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-indigo-600/20 rounded-full blur-[100px] pointer-events-none mix-blend-screen" />
      <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-purple-600/20 rounded-full blur-[100px] pointer-events-none mix-blend-screen" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-indigo-200/80">Ready to test your skills?</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          ...
          <Link to="/register" className="font-bold text-indigo-400 hover:text-indigo-300 transition-colors drop-shadow-[0_0_8px_rgba(129,140,248,0.5)]">
            Sign up
          </Link>
        </p>
      </motion.div>
